<div class="modal fade text-left" id="modal-delete-{{ $event->id }}" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel120" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="text-bold-600 " id="myModalLabel120">Eliminar</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
            <div class="modal-body">
                <h6>Confirme si desea eliminar el evento.</h6>
            </div>
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-secondary btn-svgs btn-svg-white">
                    <svg class="svg-icon" fill="white" xmlns="http://www.w3.org/2000/svg"
                ...
                <button wire:click="destroy({{ $event }})" class="btn btn-danger btn-svgs btn-svg-white">
                    <svg class="svg-icon" fill="white" xmlns="http://www.w3.org/2000/svg" height="24"
                    ...
                    <span class="btn-svg-text">Si, eliminar</span>
                </button>
            </div>
        </div>
    </div>
