...
<div class="form-body">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {{Form::datetimeLocal('start',(isset($event)) ? $event->start : null,['class'=>'form-control','autocomplete'=>'off','id'=>'start'])}}
            @error('start')
            <div class="text-danger fs-15">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {{Form::datetimeLocal('end',(isset($event)) ? $event->end : null,['class'=>'form-control','autocomplete'=>'off','id'=>'end'])}}
            @error('end')
            <div class="text-danger fs-15">{{$message}}</div>
            @enderror 
          </div>
    ...
    <div class="form-group align-middle">
        ...
        <div class="custom-switch custom-control mt-1">
            ...
            @if(old('status', $event->status) == 'ACTIVO' ) checked
            @endif>
