              ...
              <tr class="font-medium-2"> 
                ...
                <td class="text-bold-600 text-center">
                    <div class="btn-group" role="group" aria-label="Basic example">
                      @can('view', $event)    
                      <a href="{{route('events.show',$event->id)}}" class="btn btn-icon btn-info" data-toggle="tooltip" data-placement="top" data-original-title="Ver">
                          <i class="bx bx-show"></i>
                        </a>
                       @endcan 
                      @can('update', $event)    
                      <a href="{{route('events.edit',$event->id)}}" class="btn btn-icon btn-success" data-toggle="tooltip" data-placement="top" data-original-title="Editar">
                          <i class="bx bx-edit"></i>
                        </a>
                       @endcan
                       
                       <a href="{{route('events.pdf',$event->id)}}" target="_blank" class="btn btn-icon btn-warning" data-toggle="tooltip" data-placement="top" data-original-title="Imprimir">
                        <i class="bx bx-file-find"></i>
                      </a>

                        @can('forceDelete', $event)  
                        <a style="cursor:pointer" data-target="#modal-delete-{{$event->id}}" data-toggle="modal" class="btn btn-icon btn-danger" data-placement="top" data-toggle="tooltip" title="Eliminar" >
