...
<table class="action" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
    ...
    <h2 style="text-transform:uppercase">{{ $event->date->isoFormat('dddd') }} | {{ $event->name }}</h2>
    </div>
    </td>
    </tr>
    </table>
...
<table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation">
    <tr>
    <td>
    No responda este correo,  para cualquier modificación puede realizarlo desde su <a href="{{route('presencials.index')}}">plataforma</a> o solicite asistencia en el Área de Personal.
    <br>
