...
@section('actionbutton')
    <a href="{{ route('laborals.index') }}" class="btn btn-secondary">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="user-profile-text">
                        <h4 class="mb-0 text-bold-500 profile-text-color">{{ $laboral->name }}</h4>
                        <small>{{ $laboral->description }}</small>
                                ...
                                <div class="tab-pane active" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                                    ...
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <h5>Trabajadores del Régimen Laboral: {{ $laboral->name }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
