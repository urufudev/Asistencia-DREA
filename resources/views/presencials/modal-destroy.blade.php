    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="text-bold-600 " id="myModalLabel120">Eliminar registro</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="bx bx-x"></i>
          </button>
        </div>
        <div class="modal-body">
            <h6>Confirme si desea eliminar su registro de asistencia.</h6>
        </div>
        <div class="modal-footer">
            ...
            <button wire:click="destroy({{$presencial}})"  class="btn btn-danger btn-svgs btn-svg-white">
