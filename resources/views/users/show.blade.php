                          ...
                          <ul class="list-unstyled mb-0">
                            ...
                            <li class="media my-50">
                              ...
                              <div class="media-body">
                                ...
                                <small class="text-muted"> {{ Str::limit($userp->profile->position->name ?? 'Sin Descripcion',30)}}</small>
                    ...
                    <div class="card-body">
                      ...
                      <div class="list-group list-group-flush">
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0 d-flex">
                          ...
                          <div class="list-content">
                            <h5>{{ $user->profile->birthdaydate  ?: 'Sin datos'}}</h5>
                            <p class="mb-0">
                              Fecha de Nacimiento
                            </p>
                          </div>
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0 d-flex">
                          ...
                          <div class="list-content">
                            <h5>{{$user->profile->department->name ?? 'Sin datos'}} / {{$user->profile->province->name ?? 'Sin datos'}} / {{$user->profile->district->name ?? 'Sin datos'}}</h5>
                            <p class="mb-0">
