...
@section('title','Diagnosticos de COVID 19')

@section('actionbutton')
<a href="{{route('infecteds.show',$infected)}}"  class="btn btn-secondary">
        ...
        <div class="card">
            <div class="card-content">
              <div class="card-body">
                ...
                {!! Form::model($userinfected ,['route'=>['infecteds.userinfecteds.update',[$infected, $userinfected]],'method'=>'PUT']) !!}

                    @include('userinfecteds.partials.form')
