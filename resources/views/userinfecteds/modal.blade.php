...
<div class="modal fade text-left" id="modal-delete-{{$infected->id}}-{{$userinfected->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
  {!! Form::open(['route'=>['infecteds.userinfecteds.destroy',[$infected,$userinfected]],'method' => 'delete']) !!}
