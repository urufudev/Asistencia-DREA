...
@section('title', 'Condición Laboral')
...
@section('actionbutton')
    <a href="{{ route('conditions.index') }}" class="btn btn-secondary">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="user-profile-text">
                        <h4 class="mb-0 text-bold-500 profile-text-color">{{ $condition->name }}</h4>
                                ...
                                <div class="tab-pane active" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                                    ...
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <h5>Trabajadores de Condición Laboral: {{ $condition->name }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
