    ...
    <div class="col-12">
      ...
      <div class="card">
          ...
          <div class="user-profile-images">
            ...
            <!-- user profile image -->
            <img src="{{asset('images/drea/logo_admin.png')}}" style="background-color:#0D8ABC; " class="user-profile-image rounded "
              alt="user profile image" height="140" width="140">
          </div>
          <div class="user-profile-text">
            <h4 class="mb-0 text-bold-500 profile-text-color">{{$office->name}}</h4>
            <small>{{$office->description}}</small>
            ...
            <ul
              ...
              <li class="nav-item mb-0">
                <a class=" nav-link d-flex px-1 active" id="profile-tab" data-toggle="tab" href="#profile"
                  ...
                  class="d-none d-md-block"> Trabajadores</span></a>
              </li>
            ...
            <div class="tab-pane active" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                ...
                <div class="card">
                  <div class="card-content">
                    <div class="card-body">
                      <h5>Trabajadores de Oficina: {{$office->name}}</h5>
                      <div class="row">

                      @forelse($office->users->chunk(6) as $chunk)
                        <div class="col-6">
                            ...
                            <li class="media my-50">
                              ...
                              <div class="media-body">
                                <h6 class="media-heading mb-0">
                                  <a href="{{route('users.show',$userp->id)}}">{{$userp->full_namea}}</a>
                                </h6>
                                
                                
                                <small class="text-muted"> {{$userp->profile->position->name ?? 'Sin Cargo'}}</small>
                        ...
                        <div class="col-12 text-center mt-2">
                            ...
                            <div class="text-primary font-weight-bold text-center mt-2 fs-16">No hay trabajadores registrados en esta oficina.</div>
                        </div>
                        @endforelse
