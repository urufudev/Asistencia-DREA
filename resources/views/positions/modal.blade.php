...
<div class="modal fade text-left" id="modal-delete-{{$position->id}}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button wire:click="destroy({{$position}})"  class="btn btn-danger btn-svgs btn-svg-white">
